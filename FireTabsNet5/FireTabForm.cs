...
namespace FireTabsNet5
{
	...
	public class FireTabForm : Form
	{
		...
		public FireTabForm(FireTitleTab tab, FireBaseTabRenderer tabRenderer)
		{
...
// ReSharper restore DoNotCallOverridableMethodsInConstructor
	...
	/// <summary>Form that actually displays the thumbnail content for <see cref="FireTabForm" />.</summary>
