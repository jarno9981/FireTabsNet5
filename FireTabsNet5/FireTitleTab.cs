...
namespace FireTabsNet5
{
	...
	public class FireTitleTab
	{
		...
		public FireTitleTab(FireTitle parent)
		{
		...
		/// <summary>
		/// Called from <see cref="FireTabForm" /> when we need to generate a thumbnail for a tab when it is torn out of its parent window.  We simply call
