...
using FireApiCodePackShell.Taskbar;
...
#pragma warning disable 108
    ...
    // Summary: Provides the managed definition of the IPersistStream interface, with functionality from IPersist.
    [ComImport]
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    ...
    internal interface IThumbnailCache
    {
        ...
        [In] FireApiCodePackShell.Shell.ShellNativeMethods.ThumbnailOptions flags,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out FireApiCodePackShell.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags,
        [Out] FireApiCodePackShell.Shell.ShellNativeMethods.ThumbnailId pThumbnailID);

        void GetThumbnailByID([In] FireApiCodePackShell.Shell.ShellNativeMethods.ThumbnailId thumbnailID,
        [In] uint cxyRequestedThumbSize,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out FireApiCodePackShell.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags);
    }
