...
namespace FireApiCodePackShell.Taskbar
{
    /// <summary>
    ...
    public class ThumbnailToolBarManager
    {
        ...
        /// properties on the <see cref="T:FireApiCodePackShell.Taskbar.ThumbnailToolBarButton"/>. While individual buttons cannot be added or removed, 
        /// they can be shown and hidden through <see cref="P:FireApiCodePackShell.Taskbar.ThumbnailToolBarButton.Visible"/> as needed. 
