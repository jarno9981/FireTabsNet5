...
using FireApiCodePackShell.Shell.PropertySystem;
...
namespace FireApiCodePackShell.Shell
{
    ...
    public static class SearchConditionFactory
    {
        ...
        /// <param name="conditionType">The SearchConditionType of the condition node. Must be either AndCondition or OrCondition.</param>
        /// <param name="simplify">
        /// TRUE to logically simplify the result, if possible; then the result will not necessarily to be of the specified kind. FALSE if
        /// the result should have exactly the prescribed structure. An application that plans to execute a query based on the condition tree
        /// would typically benefit from setting this parameter to TRUE.
        /// </param>
        ...
        /// <see cref="P:FireApiCodePackShell.Shell.PropertySystem.ShellPropertyDescription.TypeFlags"/> property for IsQueryable flag.
        /// </remarks>
        ...
        /// <summary>
        /// Creates a leaf condition node that represents a comparison of property value and constant value. Overload method takes a DateTime
        /// parameter for the comparison value.
        /// </summary>
        /// <param name="propertyName">
        /// The name of a property to be compared, or null for an unspecified property. The locale name of the leaf node is LOCALE_NAME_USER_DEFAULT.
        /// </param>
        ...
        /// <summary>Creates a leaf condition node that represents a comparison of property value and Integer value.</summary>
        /// <param name="propertyName">
        /// The name of a property to be compared, or null for an unspecified property. The locale name of the leaf node is LOCALE_NAME_USER_DEFAULT.
        /// </param>
        ...
        /// <summary>Creates a leaf condition node that represents a comparison of property value and Boolean value.</summary>
        /// <param name="propertyName">
        /// The name of a property to be compared, or null for an unspecified property. The locale name of the leaf node is LOCALE_NAME_USER_DEFAULT.
        /// </param>
        ...
        /// <summary>
        /// Creates a leaf condition node that represents a comparison of property value and Boolean value. Overload method takes a DateTime
        /// parameter for the comparison value.
        /// </summary>
        /// <param name="propertyKey">The property to be compared.</param>
        /// <param name="value">The boolean value against which the property value should be compared.</param>
        ...
        /// <summary>
        /// Creates a leaf condition node that represents a comparison of property value and Floating Point value. Overload method takes a
        /// DateTime parameter for the comparison value.
        /// </summary>
        /// <param name="propertyKey">The property to be compared.</param>
        /// <param name="value">The Floating Point value against which the property value should be compared.</param>
        /// <param name="operation">Specific condition to be used when comparing the actual value and the expected value of the given property</param>
        ...
        /// <summary>
        /// Creates a leaf condition node that represents a comparison of property value and Integer value. Overload method takes a DateTime
        /// parameter for the comparison value.
        /// </summary>
        /// <param name="propertyKey">The property to be compared.</param>
        /// <param name="value">The Integer value against which the property value should be compared.</param>
        ...
        /// <summary>
        /// Parses an input string that contains Structured Query keywords (using Advanced Query Syntax or Natural Query Syntax) and produces
        /// a SearchCondition object.
        /// </summary>
        ...
        public static SearchCondition ParseStructuredQuery(string query, CultureInfo cultureInfo)
        {
            ...
            try
            {
                ...
                if (queryParser != null)
                {
                    ...
                    // Next, try to parse the query. Result would be IQuerySolution that we can use for getting the ICondition and other
