...
namespace FireApiCodePackShell.Shell
{
    ...
    /// <summary>
    /// Provides a set of flags to be used with <see cref="FireApiCodePackShell.Shell.SearchCondition"/> to indicate the operation in
    /// <see cref="FireApiCodePackShell.Shell.SearchConditionFactory"/> methods.
    /// </summary>
    ...
    /// <summary>Set of flags to be used with <see cref="FireApiCodePackShell.Shell.SearchConditionFactory"/>.</summary>
    public enum SearchConditionType
    {
        ...
        /// <summary>Indicates that the node is a comparison between a property and a constant value using a <see cref="FireApiCodePackShell.Shell.SearchConditionOperation"/>.</summary>
        Leaf = 3,
    }
