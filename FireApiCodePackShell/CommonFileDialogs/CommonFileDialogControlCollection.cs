...
{
    /// <summary>Provides a strongly typed collection for dialog controls.</summary>
    ...
    public sealed class CommonFileDialogControlCollection<T> : Collection<T> where T : DialogControl
    {
        ...
        /// <summary>
        /// Recursively searches for a given control id in the collection passed via the <paramref name="controlCollection"/> parameter.
        /// </summary>
