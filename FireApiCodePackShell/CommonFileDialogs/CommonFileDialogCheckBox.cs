...
namespace FireApiCodePackShell.Dialogs.Controls
{
    ...
    public class CommonFileDialogCheckBox : CommonFileDialogProminentControl
    {
        ...
        /// <summary>Creates a new instance of this class with the specified text and check state.</summary>
        /// <param name="text">The text to display for this control.</param>
        ...
        /// <summary>Creates a new instance of this class with the specified name, text and check state.</summary>
        /// <param name="name">The name of this control.</param>
        /// <param name="text">The text to display for this control.</param>
        /// <param name="isChecked">The check state of this control.</param>
        ...
        /// <summary>Attach the CheckButton control to the dialog object.</summary>
