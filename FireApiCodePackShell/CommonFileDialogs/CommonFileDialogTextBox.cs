...
namespace FireApiCodePackShell.Dialogs.Controls
{
    ...
    {
        /// <summary>Holds an instance of the customized (/native) dialog and should be null until after the Attach() call is made.</summary>
        ...
        /// <summary>Gets or sets a value for the text string contained in the CommonFileDialogTextBox.</summary>
        ...
        /// <summary>Attach the TextBox control to the dialog object</summary>
