...
namespace FireApiCodePackShell.Controls.WindowsPresentationFoundation
{
    ...
    public partial class ExplorerBrowser : UserControl, IDisposable
    {
        ...
        public ExplorerBrowser()
        {
            ...
            ExplorerBrowserControl = new FireApiCodePackShell.Controls.WindowsForms.ExplorerBrowser();
        ...
        public FireApiCodePackShell.Controls.WindowsForms.ExplorerBrowser ExplorerBrowserControl
        {
            get;
            set;
        }
        ...
        private void ItemsChanged(object sender, EventArgs e) => itemsChanged.Set();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SelectionChanged(object sender, EventArgs e) => selectionChanged.Set();
