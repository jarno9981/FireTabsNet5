...
namespace FireApiCodePackShell.Shell.PropertySystem
{
    /// <summary>
    ...
    public static class WindowProperties
    {
        ...
        public static void SetWindowProperty(IntPtr windowHandle, PropertyKey propKey, string value) => TaskbarNativeMethods.SetWindowProperty(windowHandle, propKey, value);
